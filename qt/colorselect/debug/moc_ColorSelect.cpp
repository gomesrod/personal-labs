...
const QMetaObject ColorSelect::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ColorSelect.data,
      qt_meta_data_ColorSelect,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ColorSelect::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::ColorSelect"))
        return static_cast< Ui::ColorSelect*>(const_cast< ColorSelect*>(this));
